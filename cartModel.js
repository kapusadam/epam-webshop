...
CartModel.prototype.get = function(cartId) {
    ...
    return sessionToReturn ? sessionToReturn : null;
};
...
CartModel.prototype.deleteContents = function (cartId) {
    var sessionToDeleteFrom = this.get(cartId);
    if (sessionToDeleteFrom) {
        sessionToDeleteFrom.cart = [];
    }
};